...
@interface RNKitCodePushDownloader()<NSURLSessionDelegate>
...
@implementation RNKitCodePushDownloader
...
completionHandler:(void (^)(NSString *path, NSError *error))completionHandler
{
    ...
    RNKitCodePushDownloader *downloader = [RNKitCodePushDownloader new];
